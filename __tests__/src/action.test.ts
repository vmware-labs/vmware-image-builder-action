...
describe('Given an Action', () => {
  ...
  describe('and a summarize function', () => {
    it('When an execution graph and report are provided then it displays the prettified report', () => {
      ...
      expect(core.info).toHaveBeenNthCalledWith(2, '\u001b[1mtrivy action:\u001b[22m \u001b[31mfailed\u001b[39m » Vulnerabilities: 6 minimal, 5 low, 4 medium, 3 high, \u001b[1m2 critical\u001b[22m, 1 unknown')
