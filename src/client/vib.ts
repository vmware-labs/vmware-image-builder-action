...
import { ConstraintsViolation, ExecutionGraph, ExecutionGraphBundle, ExecutionGraphsApi, Pipeline, PipelinesApi, RawReport,
...
class VIB {
  ...
  async getExecutionGraphBundle(executionGraphId: string): Promise<ExecutionGraphBundle> {
    try {
